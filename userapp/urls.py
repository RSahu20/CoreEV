...
from userapp.views import (
    ChargingStationProviderDeleteView,
    MaintenanceMan,
    SearchListView,
)
...
urlpatterns = [
    ...
    path(
        "registerConsumerSocial/",
        views.registerConsumerSocial,
        name="registerConsumerSocial",
    ),
    ...
    path(
        "Charging-Station/analytics/<int:pk>",
        views.ChargingStationAnalytics,
        name="Charging-Station-Analytics",
    ),
    path(
        "Charging-Station/dashboard/<int:pk>",
        views.ChargingStationDashboard,
        name="Charging-Station-Dashboard",
    ),
    path(
        "station/<int:pk>/delete/",
        ChargingStationProviderDeleteView.as_view(),
        name="DeleteStation",
    ),
    path(
        "Charging-Station/all-stations/",
        views.ChargingStationConsumer,
        name="Charging-Station-CLV",
    ),
    ...
    path(
        "registerMaintenance/", MaintenanceMan.as_view(), name="Register-As-Maintenance"
    ),
    path(
        "Maintenance-man/dashboard",
        views.MaintenanceDashboard,
        name="Maintenance-man-dashboard",
    ),
    path(
        "Maintenance-man/view-all", SearchListView.as_view(), name="All-Maintenance-Man"
    ),
    path(
        "Maintenance-man/complaints",
        views.MaintenanceComplaint,
